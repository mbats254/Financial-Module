...
urlpatterns = [
    ...
    path('generate_income_statement/', views.FinancialStatementGenerator.generate_income_statement, name='generate_income_statement'),
    # URL pattern for generating a balance sheet    
    path('generate_balance_sheet/', views.FinancialStatementGenerator.generate_balance_sheet, name='generate_balance_sheet'),
